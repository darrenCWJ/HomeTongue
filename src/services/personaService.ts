...
const SYSTEM_PROMPT = `You are building a user persona profile for a language learning app. The user does not speak Cantonese — they are learning to communicate with Cantonese speakers through an AI translation assistant.
