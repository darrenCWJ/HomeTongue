...
const DIALECT_LABEL = "Cantonese";
const ROMANIZATION_NAME = "Jyutping";
const SCRIPT_NAME = "Traditional Chinese";
...
{
  "formal": { "text": "<${SCRIPT_NAME}>", "pronunciation": "<${ROMANIZATION_NAME}>" },
  "casual": { "text": "<${SCRIPT_NAME}>", "pronunciation": "<${ROMANIZATION_NAME}>" },
  "slang": { "text": "<${SCRIPT_NAME}>", "pronunciation": "<${ROMANIZATION_NAME}>" },
