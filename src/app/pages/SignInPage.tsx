...
import { Globe2, Sparkles, Mail, Lock, ArrowRight, Github } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-64 bg-indigo-600 rounded-b-[2.5rem] overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-10 w-48 h-48 bg-purple-500 opacity-20 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 pt-16 pb-8 relative z-10 flex flex-col">
        ...
        >
          <div className="w-20 h-20 bg-white rounded-2xl mx-auto flex items-center justify-center shadow-lg shadow-indigo-200 mb-6">
            <Globe2 size={40} className="text-indigo-600" />
            <div className="absolute w-20 h-20 flex items-center justify-center pointer-events-none">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 border border-zinc-200 rounded-xl py-3 pl-11 pr-4 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm font-medium text-zinc-800 placeholder:font-normal"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-semibold rounded-xl py-3.5 flex items-center justify-center gap-2 transition-all disabled:opacity-70 disabled:pointer-events-none mt-6 shadow-md shadow-indigo-200"
            >
              {isLoading ? (
